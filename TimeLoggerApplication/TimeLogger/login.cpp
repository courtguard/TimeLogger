...
void Login::on_lineEditName_editingFinished()
{
    validateSign();
}
...
void Login::on_lineEditSurname_editingFinished()
{
    validateSign();
}
//After finishing with editing it checks if all the requested information is there and it enables the sign up button accordingly
...
//After finishing with editing it checks if all the requested information is there and it enables the sign up button accordingly
void Login::on_lineEditPassword_editingFinished()
{
    validateSign();
}
//After finishing with editing it checks if all the requested information is there and it enables the log in button accordingly
void Login::on_lineEditUserLog_editingFinished()
{
    validateLog();
}
//After finishing with editing it checks if all the requested information is there and it enables the log in button accordingly
void Login::on_lineEditPassLog_editingFinished()
{
    validateLog();
}
