    ...
    ui(new Ui::TimeStatus)
{
    ...
    connect(&m_addProjectDialog, SIGNAL(dataUpdated()), this, SLOT(onDataUpdated()));
...
//Opens the Project Window dialog
void TimeStatus::on_buttonAddProject_clicked()
{
    m_addProjectDialog.setValues();
    m_addProjectDialog.setWindowTitle("Project Window");
    m_addProjectDialog.exec();
}
