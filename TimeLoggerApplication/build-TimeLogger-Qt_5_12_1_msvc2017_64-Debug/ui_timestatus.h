...
"}"));
        ...
        buttonAddTime->setMinimumSize(QSize(0, 30));
        QFont font6;
...
""));
        ...
        buttonAddProject = new QPushButton(TimeStatus);
        buttonAddProject->setObjectName(QString::fromUtf8("buttonAddProject"));
        buttonAddProject->setMinimumSize(QSize(0, 30));
        buttonAddProject->setFont(font6);
        buttonAddProject->setStyleSheet(QString::fromUtf8("QPushButton {	\n"
"	background-color: rgb(64, 150, 244);\n"
"	border-radius: 5px;\n"
"	color: rgb(255, 255, 255);\n"
"	border:none\n"
...
""));
        ...
        verticalLayout_2->addWidget(buttonAddProject);
...
"}"));
    ...
    {
        TimeStatus->setWindowTitle(QApplication::translate("TimeStatus", "Form", nullptr));
        labelUser->setText(QApplication::translate("TimeStatus", "User:", nullptr));
        label->setText(QApplication::translate("TimeStatus", "Time Status", nullptr));
        buttonPreviousWeek->setText(QString());
        labelFirstDay->setText(QApplication::translate("TimeStatus", "TextLabel", nullptr));
        labelLastDay->setText(QApplication::translate("TimeStatus", "TextLabel", nullptr));
        labelYear->setText(QApplication::translate("TimeStatus", "TextLabel", nullptr));
        buttonNextWeek->setText(QString());
        label_2->setText(QApplication::translate("TimeStatus", "Hours Logged this Week", nullptr));
        labelHours->setText(QApplication::translate("TimeStatus", "0", nullptr));
        buttonAddTime->setText(QApplication::translate("TimeStatus", "ADD TIME", nullptr));
        buttonAddProject->setText(QApplication::translate("TimeStatus", "  ADD PROJECT  ", nullptr));
        label_3->setText(QApplication::translate("TimeStatus", "Details", nullptr));
        QTableWidgetItem *___qtablewidgetitem = tableWidgetProjectDetails->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("TimeStatus", "Project", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidgetProjectDetails->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("TimeStatus", "Monday", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidgetProjectDetails->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("TimeStatus", "Tuesday", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidgetProjectDetails->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("TimeStatus", "Wednesday", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidgetProjectDetails->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("TimeStatus", "Thursday", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = tableWidgetProjectDetails->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("TimeStatus", "Friday", nullptr));
        QTableWidgetItem *___qtablewidgetitem6 = tableWidgetProjectDetails->horizontalHeaderItem(6);
        ___qtablewidgetitem6->setText(QApplication::translate("TimeStatus", "Saturday", nullptr));
        QTableWidgetItem *___qtablewidgetitem7 = tableWidgetProjectDetails->horizontalHeaderItem(7);
        ___qtablewidgetitem7->setText(QApplication::translate("TimeStatus", "Sunday", nullptr));
        QTableWidgetItem *___qtablewidgetitem8 = tableWidgetProjectDetails->horizontalHeaderItem(8);
        ___qtablewidgetitem8->setText(QApplication::translate("TimeStatus", "Total", nullptr));
        QTableWidgetItem *___qtablewidgetitem9 = tableWidgetReportDetails->horizontalHeaderItem(0);
        ___qtablewidgetitem9->setText(QApplication::translate("TimeStatus", "Date", nullptr));
        QTableWidgetItem *___qtablewidgetitem10 = tableWidgetReportDetails->horizontalHeaderItem(1);
        ___qtablewidgetitem10->setText(QApplication::translate("TimeStatus", "Project", nullptr));
        QTableWidgetItem *___qtablewidgetitem11 = tableWidgetReportDetails->horizontalHeaderItem(2);
        ___qtablewidgetitem11->setText(QApplication::translate("TimeStatus", "Work Description", nullptr));
        QTableWidgetItem *___qtablewidgetitem12 = tableWidgetReportDetails->horizontalHeaderItem(3);
        ___qtablewidgetitem12->setText(QApplication::translate("TimeStatus", "Hours", nullptr));
        QTableWidgetItem *___qtablewidgetitem13 = tableWidgetReportDetails->horizontalHeaderItem(4);
        ___qtablewidgetitem13->setText(QApplication::translate("TimeStatus", "Options", nullptr));
    } // retranslateUi
